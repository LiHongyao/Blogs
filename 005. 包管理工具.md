...
1. 在用户根目录中克隆 nvm 仓库（Github 下载nvm）

   ```shell
   $ cd ~/ && git clone https://github.com/nvm-sh/nvm.git .nvm
   ```

2. 进入 nvm 目录，自动找出并切换至最新版本，然后执行安装程序
...
- 查询远程库版本：`nvm ls-remote`
- 安装最新版本：`nvm install node`
- 安装指定版本：`nvm install v14.16.0`
- 卸载指定版本：`nvm uninstall v14.16.0`
- 切换至指定版本：`nvm use v14.16.0`
- 查看当前使用版本：`nvm current`
- 设置默认版本：`nvm alias default 14.16.0`
...
```shell
$ which node 
/Users/lihongyao/.nvm/versions/node/v14.16.0/bin/node
$ which npm
/Users/lihongyao/.nvm/versions/node/v14.16.0/bin/npm
```
