...
webpack 最新版本为：v4.1.0，本节主要基于 v3.11.0 版本讲解。
...
创建一个 “src/js/index.js” 文件，里面任意写一些逻辑，如下所示：
...
观察项目目录结构，会生成一个dist文件，文件下方js文件目录下的 “bundle.js” 文件就是打包生成的文件。
...
模块0引用了模块1和模块2，然后将其打包输出成一个 ”bundle.js“ 文件，这样就实现了js文件的合并操作。
...
module.exports = {
    ...
    devServer: {
        contentBase: path.resolve(__dirname, "./dist"), // 本地服务器所加载的页面所在的目录
  		host: "192.168.199.207", // host 是你自己的ip地址
...
假想，现在我们正在下载 CSS，但是我们的背景和图标这些图片，要如何处理呢？使用 [file-loader](https://doc.webpack-china.org/loaders/file-loader)，我们可以轻松地将这些内容混合到 CSS 中：
...
[file-loader & url-loader 区别](http://blog.csdn.net/qq_38652603/article/details/73835153)
