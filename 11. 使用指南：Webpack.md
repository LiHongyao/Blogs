...
- 权限问题，在Liux、Mac安装是需要sudo权限，如果你是Windows系统，主要要使用以管理员方式安装。
...
> 提示：注意 “main” 字段中我指向了稍后会创建的“main.js”文件。
...
```json
"scripts": {
    "dev": "webpack --config webpack.dev.config.js  --mode development -w"
}
```
