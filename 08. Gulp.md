...
在学习前，先谈谈大致使用gulp的步骤，给读者以初步的认识。通过yarn安装gulp，其次在项目里安装所需要的gulp插件，然后新建gulp的配置文件 *“gulpfile.js”* 并写好配置信息（定义gulp任务），最后通过命令提示符运行gulp任务即可。
...
### 1.4. [gulp-babel](<https://www.npmjs.com/package/gulp-babel>)
...
or
$ yarn add -D gulp-notify gulp-plumber 
```
...
### 4.1. [gulp-rename](<https://www.npmjs.com/package/gulp-rename>)
