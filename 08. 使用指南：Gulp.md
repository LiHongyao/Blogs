...
gulp.task('watch', function () {
   ...
   gulp.watch('./src/style/less/*.less', ['compile-less']);
});
...
### 2.1. [gulp-cssnano](https://www.npmjs.com/package/gulp-cssnano)
...
### 2.3. [gulp-imagemin](https://github.com/sindresorhus/gulp-imagemin)
...
### 2.4. [gulp-htmlmin](https://github.com/jonschlinkert/gulp-htmlmin)
...
说明：显示报错信息、报错后不终止当前gulp任务。

安装：

```shell
$ npm i --save-dev gulp-notify gulp-plumber 
```
...
### 4.2. [gulp-concat](https://github.com/contra/gulp-concat)
...
```shell
$ npm i gulp del vinyl-paths --save-dev
```
...
说明：重写被gulp-rev重命名的文件名。

安装：

```shell
$ npm i gulp-rev-replace --save-dev
```
